  ...
  render: ->
    <div id="bio" className="long ui modal">
      ...
      <div className="content">
        ...
        <img className="ui right floated small image" src="images/me.jpg" style={{width: "200px"}}></img>
